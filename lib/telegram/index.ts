...
export function getTelegramWelcomeMessage(email: string) {
  return [
    `✅ Telegram подключен к аккаунту <b>${escapeTelegramHtml(email)}</b>.`,
    '',
    '<b>Что будет приходить:</b>',
    '• дневная сводка по компаниям из вашего списка;',
    '• актуальные цены и дневное изменение на момент отправки;',
    '• краткий анализ важных новостей по отслеживаемым тикерам;',
    '• общий рыночный контекст, если по вашему списку мало новостей.',
    '',
    '<b>Как пользоваться:</b>',
    '1. Добавляйте компании в раздел «Мой список» на сайте.',
    '2. Включайте или отключайте Telegram-уведомления там же.',
    '3. Нажимайте «Отправить сводку сейчас», если хотите проверить уведомление вручную.',
    '',
    'Плановая дневная сводка будет приходить автоматически, когда Inngest запускает расписание.',
  ].join('\n');
}
